...
let websockets = {};
let chatContext = [];
let availableTopics = ['Sales', 'Marketing', 'Finance', 'Operations', 'HR'];
let cardsByTopic = {};
...
async function sendChatMessage() {
    ...
    try {
        ...
        // Handle tool results (if AI used a tool to create/modify data)
        if (data.tool_result && data.tool_result.success) {
            // Add or update the card on the dashboard
            addDataCard(data.tool_result.data, data.tool_result.data_id);
        }
